...
import { deleteUsersByIds,signup, login,loginAdmin ,SendOTP,ChangeForgotPassword,is_verified,updateUser,GetAllUser,GetAllLineManagers,GetAllManagers,GetAllEmployees,getUserImageById,getManagerByUserId,getUserNameByIdd} from '../api/User/authController.js';
...
authRouter.post('/getUserNameByIdd', getUserNameByIdd);
